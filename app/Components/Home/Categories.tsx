    ...
    "
      >
        {categoriesData.map((cat) => (
          <div
            className="flex flex-col rounded-full h-16 w-16 items-center justify-center p-3 cursor-pointer
             shrink-0 overflow-hidden hover:bg-slate-200"
             key={cat.id}
          >
            <Image src={cat.imageSrc} width={60} height={60} alt="cat-img"/>
